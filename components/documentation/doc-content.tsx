...
import { ButtonPreview } from '@/app/components/preview/button-preview'
...
const DocContentInner = () => {
  ...
  const [currentTheme, setCurrentTheme] = useState<ThemeType>('vscDarkPlus')
  ...
  return (
    <div className='mx-auto flex w-full max-w-6xl justify-center px-4 py-8 md:px-8'>
      ...
      >
        ...
        <ReactMarkdown components={components}>{currentContent}</ReactMarkdown>
